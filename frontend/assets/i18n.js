// Hermes WebUI - Internationalization
// 支持英文和中文
...
const i18n = {
  en: {
    // Onboarding
    onboard: {
      welcome: 'Welcome to Hermes WebUI',
  ...
  zh: {
    // Onboarding
    onboard: {
      welcome: '欢迎使用 Hermes WebUI（马鞍）',
      namePlaceholder: '例如：阿特拉斯、小助手、Jarvis 🤖',
...
function saveLanguage(lang) {
  localStorage.setItem('hermes_webui_language', lang);
}

// 加载语言设置
function loadLanguage() {
  return localStorage.getItem('hermes_webui_language') || detectLanguage();
}
