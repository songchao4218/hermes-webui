...
class HermesBridge:
    ...
    def __init__(self, hermes_home: Optional[str] = None):
        ...
        # Auto-create directories if they don't exist (for standalone mode)
    ...
    def get_config(self) -> dict:
        ...
        try:
            ...
            print(f"Warning: Failed to parse Hermes config: {e}")
            return {}
        except Exception as e:
            print(f"Warning: Could not read Hermes config: {e}")
            return {}

    def get_ollama_url(self) -> str:
        """Extract Ollama base URL from Hermes config"""
        # Environment variable takes highest priority (useful for Docker)
